...
const Formulario = () => {
    return (
        <div className='md:w-1/2 lg:w-2/5'>
            ...
            <form className='bg-white shadow-md rounded-lg py-10 px-5 ml-10 mb-10'>
                <div className='mt-5'>
                ...
                <div className='mt-5'>
                    ...
                    <input className='border-2 bg-gray-100 w-full p-2 mt-2 placeholder-gray-400 rounded-md
                    shadow-sm border-slate-300 focus:outline-none focus:border-sky-500
                    focus:ring-sky-500' type='text' id='nombre propietario' placeholder='Nombre del propietario' />
                </div>
                <div className='mt-5'>
                    <label htmlFor='email' className='block text-gray-700 uppercase font-bold'>Email</label>
                    <input className='border-2 bg-gray-100 w-full p-2 mt-2 placeholder-gray-400 rounded-md
                    shadow-sm border-slate-300 focus:outline-none focus:border-sky-500
                    focus:ring-sky-500' type='email' id='email' placeholder='Email de Contato Propietario' />
                </div>
                <div className='mt-5'>
                    <label htmlFor='fecha de alta' className='block text-gray-700 uppercase font-bold'>Fecha de Alta</label>
                    <input className='border-2 bg-gray-100 w-full p-2 mt-2 placeholder-gray-400 rounded-md
                    shadow-sm border-slate-300 focus:outline-none focus:border-sky-500
                    focus:ring-sky-500' type='date' id='fecha de alta' />
                </div>
                <div className='mt-5'>
                   ...
                   <textarea className='border-2 bg-gray-100 w-full p-2 mt-2 placeholder-gray-400 rounded-md
                    shadow-sm border-slate-300 focus:outline-none focus:border-sky-500
                    focus:ring-sky-500' id='síntomas' placeholder='Describe los síntomas' />
                </div>
